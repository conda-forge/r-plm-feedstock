About r-plm-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-plm-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3433&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-plm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-plm` can be installed with `conda`:
...
It is possible to list all of the versions of `r-plm` available on your platform with `conda`:
...
```
mamba search r-plm --channel conda-forge
```
...
mamba repoquery search r-plm --channel conda-forge

# List packages depending on `r-plm`:
mamba repoquery whoneeds r-plm --channel conda-forge

# List dependencies of `r-plm`:
mamba repoquery depends r-plm --channel conda-forge
```
